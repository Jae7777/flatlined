...
const UnitedHomeConstructionPage = () => {
  ...
  return (
    <div className='h-full'>
      ...
      >
        <Showcase
          url='/showcases/unitedhomeconstruction.png'
          isToggled={isToggled}
          isLive={false}
          name='United_Home_Construction'
        />
        
        <div className='flex flex-wrap max-w-[250px] mx-auto py-3'>
          <LinkButton
            url='https://www.unitedhomeconstructioncorp.com/'
          />
        </div>
...
export default UnitedHomeConstructionPage