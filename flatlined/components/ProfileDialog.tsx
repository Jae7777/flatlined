...
const profiles = [
  ...
  },
  {
    ...
    title: 'Resume',
    action: <Link href="/Chen_Justin_resume.pdf" locale={false} target="_blank" rel="noopener noreferrer" className="hover:text-sky-400 duration-150 hover:translate-y-1"><IconDownload size={24}/></Link>,
  },
  {
